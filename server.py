...
wScr, hScr = (
    1536,
    900,
)  # Enter your screen resolution here. Get screen resolution from here - https://bestfirms.com/what-is-my-screen-resolution/


# HAND TRACKING MODULE ATTACHED
class handDetector:
    def __init__(
        self, mode=False, maxHands=1, complexity=1, detectionCon=0.7, trackCon=0.5
    ):
        self.mode = mode
    ...
    def findPosition(self, img, handNo=0, draw=True):
        ...
        if self.results.multi_hand_landmarks:
            ...
            if draw:
                cv2.rectangle(
                    img, (xmin - 20, ymin - 20), (xmax +
                                                  20, ymax + 20), (0, 255, 0), 2
                )
